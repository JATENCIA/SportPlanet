...
export default function SellProduct(){
    ...
    return (
        ...
        <form onSubmit={submitHandler}>
            <h1 className="text-3xl font-bold text-gray-900 mb-5 text-center border-b-2 border-gray-800">Post the product you want to sell!</h1>
            {console.log(post)}
            <div>
            ...
            <div className="mt-8"><button type="submit" className="bg-gray-700 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded mx-auto block">POST THIS PRODUCT</button></div>
        </form>
        </div>
        </>
    )
